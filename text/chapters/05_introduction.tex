...
V dnešní době se můžeme setkat s \index{GIS} geoinformačními (GIS)
...
prohlížení, zpracování a analýzu \index{geodata} geodat, můžeme
...
Můžeme se setkat s pojmy jako \begin{scriptsize}model
  builder\end{scriptsize} či \begin{scriptsize}graphical
    ...
    pojem \begin{scriptsize}workflow builder\end{scriptsize}. Tento
      název byl převzat z projektu \index{VisTrails} VisTrails, který
...
%, nežli při hledání procházet všechny možné pluginy.

V době psaní této diplomové práce existoval projekt \index{QGIS
  Processing Framework} \textbf{QGIS Processing Framework} studenta
...
z jiného GIS nástroje - \index{SAGA GIS} SAGA GIS. V době psaní této
...
Aktuální verzi Workflow Builderu můžeme najít na přiloženém cd,
případně zde:
