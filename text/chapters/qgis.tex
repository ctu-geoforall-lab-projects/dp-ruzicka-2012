...
označil \index{fTools} \textbf{fTools}\footnote{http://www.ftools.ca/},
který umožňuje pokročilé prostorové analýzy nad vektorovými
daty, \index{GDAL,
GdalTools} \textbf{GdalTools}\footnote{http://www.faunalia.co.uk/gdaltools}
pro práci s rastrovými daty a již zmíněný \index{GRASS
Plugin} \textbf{GRASS
