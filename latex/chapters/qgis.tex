...
%Tvorba zásuvných modulů se - pomoci Plugin Builderu[obr] ci od piky, pripadne si stahnou jiz nejaky hotovy plugin a učit se z něj. Struktura adresare s pluginem. Nutne soubory a co v nich. 
